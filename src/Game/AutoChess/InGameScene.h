...
private:
    ...
    // ヘルプを開くチュートリアルを始める関数
    //----------------------------------------------------------------------
    void HelpOpenTutorialEnter();

    //----------------------------------------------------------------------
    // ヘルプを開くチュートリアルのアップデート関数
    //----------------------------------------------------------------------
    void HelpOpenTutorialUpdate();

    //----------------------------------------------------------------------
    // ヘルプを開くチュートリアルを終わる関数
    //----------------------------------------------------------------------
    void HelpOpenTutorialExit();

    //----------------------------------------------------------------------
    // ヘルプを閉じるチュートリアルを始める関数
    //----------------------------------------------------------------------
    void HelpCloseTutorialEnter();

    //----------------------------------------------------------------------
    // ヘルプを閉じるチュートリアルを更新する関数
    //----------------------------------------------------------------------
    void HelpCloseTutorialUpdate();

    //----------------------------------------------------------------------
    // ヘルプを閉じるチュートリアルを終わる関数
    //----------------------------------------------------------------------
    void HelpCloseTutorialExit();

    //@}
private:
    TsukinoDIContainer::Container                       di_container_;    //DIコンテナ
    std::array<std::array<std::weak_ptr<Object>, 8>, 8> squares_;         //見かけ上のマス目群
    Timer                                               phase_timer_;
