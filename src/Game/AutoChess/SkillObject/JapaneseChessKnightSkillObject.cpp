//---------------------------------------------------------------------------
//!	@file	JapaneseChessKnightSkillObject.cpp
//! @brief	チェスビショップのスキルオブジェクト
//! @auther 山﨑愛
//---------------------------------------------------------------------------
#include "JapaneseChessKnightSkillObject.h"
#include <System/Component/ComponentCollisionSphere.h>
#include <Game/AutoChess/Piece/Piece.h>
//---------------------------------------------------------------------------------
//!	初期化
//---------------------------------------------------------------------------------
bool JapaneseChessKnightSkillObject::Init()
{
    __super::Init();

    SetName(u8"跳躍");
    SetEffect(u8"data/AutoChess/Effect/JapaneseChessKnightSkill.efkefc");
    SetEffectPlaySpeed(0.3f);
    //---------------------------------------------------------------------------------
    // コリジョンを追加
    //---------------------------------------------------------------------------------
...
//! @brief ヒット時のコールバック関数
//---------------------------------------------------------------------------
void JapaneseChessKnightSkillObject::OnHit(const ComponentCollision::HitInfo& hit_info)
{
...
//! @brief 移動ベクトルを設定する関数
//---------------------------------------------------------------------------
void JapaneseChessKnightSkillObject::SetMoveVector(const float3& move_vector)
{
...
//! @brief 攻撃力を設定する関数
//---------------------------------------------------------------------------
void JapaneseChessKnightSkillObject::SetAttackPower(int power)
{
    attack_power_ = power;
}
