...
//! 所持金を返す関数
//-----------------------------------------------------------
int Agent::GetGold() const
{
    return agent_info_.GetGold();
}
...
//! 所持金を減らす関数
//-----------------------------------------------------------
bool Agent::SpendGold(int gold)
{
    return agent_info_.SpendGold(gold);
}
